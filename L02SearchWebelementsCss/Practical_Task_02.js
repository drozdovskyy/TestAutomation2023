...
//
// Task 6.1
// Determine the current day: Locate the day that has the class current-number and display its value. (Expected result, for example, "Current day: 20 September 2023").
//

function task_6_1() {
    var currentNumber = document.querySelector('.current-number');
    if (currentNumber == null) {
        console.log("There are no elements with class 'current-number' on this page.");
    } else {
...
// Task 6.3
// Determine the displayed days of the week: Collect all elements with the class day-name and display their names.
//
...
function task_6_3() {
    ...
    if (weekDays.length == 0) {
        console.log("There are no elements with class day-name on this page");
    } else {
